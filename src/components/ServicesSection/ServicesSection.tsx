      ...
      <Carousel.Item key={item._id}>
        <div className="mx-auto max-w-[900px] flex flex-col lg:flex-row justify-between items-start lg:items-center lg:h-[300px]  h-[300px]">
          ...
          <div className="bg-black w-full text-white p-4 ">
              ...
              <div className="flex flex-wrap items-center"><h4 className="text-xl my-3 mr-3 flex items-center">Starting Price: </h4> <h3 className="font-bold my-3">{item.charge}</h3></div>
          </div>
        </div>
      </Carousel.Item>
    );
